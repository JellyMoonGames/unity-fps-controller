// GENERATED AUTOMATICALLY FROM 'Assets/Settings/Input/CharacterControllerControls.inputactions'
...
public class @CharacterControllerControls : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @CharacterControllerControls()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""CharacterControllerControls"",
    ""maps"": [
        {
            ""name"": ""Movement"",
    ...
    {
        private @CharacterControllerControls m_Wrapper;
        public MovementActions(@CharacterControllerControls wrapper) { m_Wrapper = wrapper; }
